...
namespace {
    ...
    class Artisan extends \Illuminate\Support\Facades\Artisan{
        ...
        public static function handle($input, $output = null){
            ...
            return \CalendarDemo\Console\Kernel::handle($input, $output);
        }
        ...
        public static function terminate($input, $status){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \CalendarDemo\Console\Kernel::terminate($input, $status);
        }
        ...
        public static function call($command, $parameters = array()){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \CalendarDemo\Console\Kernel::call($command, $parameters);
        }
        ...
        public static function queue($command, $parameters = array()){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \CalendarDemo\Console\Kernel::queue($command, $parameters);
        }
        ...
        public static function all(){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \CalendarDemo\Console\Kernel::all();
        }
        ...
        public static function output(){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \CalendarDemo\Console\Kernel::output();
        }
        ...
        public static function bootstrap(){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \CalendarDemo\Console\Kernel::bootstrap();
        }
    ...
    class Calendar extends \MaddHatter\LaravelFullcalendar\Facades\Calendar{
         ...
         * @param string|\MaddHatter\LaravelFullcalendar\DateTime $start If string, must be valid datetime format: http://bit.ly/1z7QWbg
         * @param string|\MaddHatter\LaravelFullcalendar\DateTime $end If string, must be valid datetime format: http://bit.ly/1z7QWbg
         * @param string $id event Id
         * @return \MaddHatter\LaravelFullcalendar\SimpleEvent 
         * @static 
         */
        public static function event($title, $isAllDay, $start, $end, $id = null){
            return \MaddHatter\LaravelFullcalendar\Calendar::event($title, $isAllDay, $start, $end, $id);
        }
         ...
         * Add an event
         *
         * @param \MaddHatter\LaravelFullcalendar\Event $event
         * @param array $customAttributes
         * @return $this 
         * @static 
         */
